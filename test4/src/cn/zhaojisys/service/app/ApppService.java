...
public interface ApppService {
	...
	// 短信验证码登录
	public Vipuserinfo loginphone(@Param("phoneNum") String phoneNum)
			throws Exception;

	// 查询短信验证码登录类型
	public Gasstation loginType2(@Param("mobilePhone") String mobilePhone)
			throws Exception;
	...
	public int addVipuserinfo(@Param("userName")String userName,
			...
			@Param("createTime")String createTime,String uploadImg)throws Exception;
	//我的账户

...
$('.btn_business').on('click', function(){
    $.layer({
		...
		shift:['bottom', 300, 1],
        page: {
			html: '<div style="padding:20px;"><div class="col-md-12"><div class="form-group"><label class="col-sm-5 control-label">开户银行：</label><div class="col-sm-7"><input type="text" name="" class="form-control" placeholder="请输入文本"> <span class="help-block m-b-none">说明文字</span></div></div><div class="form-group"><label class="col-sm-5 control-label">税务登记：</label><div class="col-sm-7"><input type="text" name="" class="form-control" placeholder="请输入文本"> <span class="help-block m-b-none">说明文字</span></div></div><div class="form-group"><label class="col-sm-5 control-label">账户信息：</label><div class="col-sm-7"><input type="text" name="" class="form-control" placeholder="请输入文本"> <span class="help-block m-b-none">说明文字</span></div></div><div class="form-group"><label class="col-sm-5 control-label">发票抬头：</label><div class="col-sm-7"><input type="text" name="" class="form-control" placeholder="请输入文本"> <span class="help-block m-b-none">说明文字</span></div></div><div class="form-group"><label class="col-sm-5 control-label">纳税人识别号：</label><div class="col-sm-7"><input type="text" name="" class="form-control" placeholder="请输入文本"><span class="help-block m-b-none">说明文字</span></div></div><div class="form-group"><label class="col-sm-5 control-label">账户状态：</label><div class="col-sm-7"><label class="radio-inline"><input type="radio" checked="" value="option1" id="optionsRadios1" name="optionsRadios">正常</label><label class="radio-inline"><input type="radio" value="option2" id="optionsRadios2" name="optionsRadios">关闭</label><label class="radio-inline"><input type="radio" value="option3" id="optionsRadios2" name="optionsRadios">冻结</label></div></div><div class="form-group"><div class="col-sm-12 col-sm-offset-3"><button class="btn btn-primary" type="submit">保存内容</button><button class="btn btn-white" type="submit">取消</button></div></div></div></div>'
			
			//url:'../../supplier_bussniess.html'
		}
	});
});
...
conf.anode.each(function(index){
    ...
    othis.on('click', function(e){
        switch(index){
            case 0:
                layer.alert('恭喜！供应商数据已经添加成功！', 1, '数据提示框', function(){
                    layer.msg('供应商数据已经添加成功！', 1, -1, function(){
                        layer.msg('您可继续添加更多供应商信息！',8 , {
                            type:9, 
                            rate: 'bottom', 
                            shade: [0]
                        });
            ...
            case 3:
                var iss, fnpop = function(obj, call){
                    ...
                    var pageii = $.layer({
                        ...
                        title: [
						        '分配账号信息',
                                'border:none; background:#2a8aff; color:#fff;'
								],
                        ...
                        page: {
                            html: '<div style="width:600px; height:300px; padding:20px; background-color:#e5e5e5;"><div class="col-md-12"><div class="form-group"><label class="col-sm-3 control-label">账号：</label><div class="col-sm-9"><input type="text" name="" class="form-control" placeholder="请输入文本"> <span class="help-block m-b-none">说明文字</span></div></div><div class="form-group"><label class="col-sm-3 control-label">密码：</label><div class="col-sm-9 help-block"><input type="password" class="form-control" name="password" placeholder="请输入密码"></div></div><div class="form-group"><label class="col-sm-3 control-label">确认密码：</label><div class="col-sm-9 help-block"><input type="password" class="form-control" name="password" placeholder="请输入密码"></div></div></div><button class="pagebtn btn btn-w-m btn-warning btn-sm" >保存</button></div>'
                ...
                fnpop({
                    ...
                    return
                    $('html, body').stop().animate({scrollTop: $('#aad336').offset().top}, 500, function(){
                        setTimeout(function(){
                            iss || fnpop({fix: false});
                            iss = true;
                        }, 100);

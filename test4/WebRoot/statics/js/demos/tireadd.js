...
$(function(){ 
	...
	$("#saves").click(function () {
        ...
        //轮胎品牌
        /*if($('input[name=optionsRadios1]').is(':checked')==false) {
            swal("请选择轮胎品牌！");
            return false;
        }*/
        //轮胎规格
        /*if($('input[name=optionsRadios2]').is(':checked')==false) {
            swal("请选择轮胎规格！");
            return false;
        }*/
        //轮胎材质
        /*if($('input[name=optionsRadios3]').is(':checked')==false) {
            swal("请选择轮胎材质！");
            return false;
        }*/
        //请输入账号

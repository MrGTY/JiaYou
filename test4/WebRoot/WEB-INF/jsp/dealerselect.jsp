                        ...
                        <div class="col-lg-12 bordered">
                            ...
                            <div class="col-lg-8 col-md-9  p20">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="siteName" readonly="readonly" value="${gass.siteName}" id="zdname" required
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                    <textarea class="col-md-10col-sm-12 col-xs-12" name="description" readonly="readonly" rows="3" id="base_case"

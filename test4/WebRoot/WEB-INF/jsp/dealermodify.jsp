...
<head>
	...
	<title>修改燃油站点</title>
	<meta name="keywords" content="修改燃油站点">
    <meta name="description" content="修改燃油站点">
        ...
        <div class="wrapper wrapper-content animated">
            <div class="white-bg">
                <div class="row ibox-content p20">
                    <form method="post" action="gasstationmodifysave" class="form-horizontal">
                        ...
                        <div class="col-lg-12 bordered">
                            ...
                            <div class="col-lg-8 col-md-9  p20">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="siteName" value="${gass.siteName}" id="zdname" required
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-2 col-sm-10 ">
                                            <input type="text" value="${gass.longitude}" id="jd" required  name="longitude" class="form-control" placeholder="">
                                        </div>
                                        <label class=" col-sm-1 control-label"><span
                                                class="text-danger">*</span>纬度:</label>
                                        <div class="col-md-2 col-sm-10 ">
                                            <input type="text" name="latitude" value="${gass.latitude}" id="wd" required  class="form-control" placeholder="">
                                        </div>
                                        <div class="col-md-2 col-sm-10 ">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-2 col-sm-10 ">
                                            <input type="text" name="coverRadius" value="${gass.coverRadius}" id="sh" required  class="form-control" placeholder="KM">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3 col-sm-10 ">
                                            <input type="text" name="contact" value="${gass.contact}" id="lxr" required  class="form-control" placeholder="请输入联系人">
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" name="charge" value="${gass.charge}" required id="fuwu" class="form-control" placeholder="元/L">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                    <textarea class="col-md-10col-sm-12 col-xs-12" name="description" rows="3" id="base_case"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" name="code" value="${gass.code}" id="codename" readonly="readonly" class="form-control" placeholder="请输入账号">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="text-danger">*</span>密码:</label>
                                    <div class="col-sm-5">
                                        <input type="password" name="password" value="${gass.password}" required id="pwd" class="form-control" placeholder="请输入密码">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group col-sm-12">
                                    <div class=" col-sm-6" style="text-align: center">
                                        ...
                                        <input style="width: 30%" onclick="backlist();" value="取消" class="btn btn-md btn-default"/><br>
                                        <div>${error}</div>
                                    </div>
                                </div>
                            </div>
...
<script src="${pageContext.request.contextPath}/statics/js/demos/Dealermodify.js"></script>

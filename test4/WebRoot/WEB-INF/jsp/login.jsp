...
<head>
    ...
    <title>召集油联盟站点登录</title>
    <meta name="keywords" content="召集购油平台站点登录">
    <meta name="description" content="召集购油平台站点登录">
...
<body class="login-bg">
  ...
  <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            <div>
                <h5 class="logo-name">召集油联盟站点登录</h5>
            </div>
            <form class="m-t" role="form" action="login" method="post">
                <div class="form-login">
                    <label class="form-login-name">用户名：</label><input type="text" name="code" value="" class="form-control" placeholder="用户名" required="">
                </div>
                <div class="form-login">
                    <label class="form-login-name">密　码：</label><input type="password"  name="password" value="" class="form-control" placeholder="密码" required="">
                </div>

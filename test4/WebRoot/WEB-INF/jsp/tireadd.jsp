...
<head>
	...
	<title>新增轮胎站点</title>
	<meta name="keywords" content="新增轮胎站点">
    <meta name="description" content="新增轮胎站点">
        ...
        <div class="wrapper wrapper-content animated">
            <div class="white-bg">
                <div class="row ibox-content p20">
                    <form method="post" class="form-horizontal" action="tireadd">
                        ...
                        <div class="col-lg-12 bordered">
                            ...
                            <div class="col-lg-8 col-md-9  p20">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="siteName" class="form-control" id="zdname" required
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="detaileAddress" id="address" required class="form-control" placeholder="请输入详细地址">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-2 col-sm-10 ">
                                            <input type="text" name="longitude" id="jd" required class="form-control" placeholder="">
                                        </div>
                                        <label class=" col-sm-1 control-label"><span
                                                class="text-danger">*</span>纬度:</label>
                                        <div class="col-md-2 col-sm-10 ">
                                            <input type="text" name="latitude" id="wd" required class="form-control" placeholder="">
                                        </div>
                                        <div class="col-md-2 col-sm-10 ">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3 col-sm-10 ">
                                            <input type="text" name="contact" id="lxr" required  class="form-control" placeholder="">
                                        </div>
                                        <label class=" col-sm-1 control-label"><span
                                                class="text-danger">*</span>手机:</label>
                                        <div class="col-md-3 col-sm-10 ">
                                            <input type="text" name="mobilePhone" required id="phone" pattern="^1[123456789]\d{9}$" class="form-control" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" name="initialOil" required id="cs" class="form-control" placeholder="元">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-lg-8 itit_radio">
                                        	<c:forEach var="s1" items="${tyreBrands}">
                                        		<label class="radio-inline"> <input type="checkbox"  value="${s1}"  name="optionsRadios1">${s1}</label>
                                        	</c:forEach>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-lg-8 itit_radio">
                                        	<c:forEach var="s2" items="${typrSpecs}">
                                            	<label class="radio-inline"> <input type="checkbox"  value="${s2}"  name="optionsRadios2">${s2}</label>
                                        	</c:forEach>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-lg-8 itit_radio">
                                            <c:forEach var="s3" items="${typrMaterials}">
                                            	<label class="radio-inline"> <input type="checkbox"  value="${s3}"  name="optionsRadios3">${s3}</label>
                                        	</c:forEach>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                    <textarea class="col-md-10col-sm-12 col-xs-12" rows="3" name="description"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" name="code" required id="codename" readonly="readonly" class="form-control" placeholder="请输入账号">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="text-danger">*</span>密码:</label>
                                    <div class="col-sm-5">
                                        <input type="password" name="password" required id="pwd" class="form-control" placeholder="请输入密码">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span
...
<script src="${pageContext.request.contextPath}/statics/js/demos/tireadd.js"></script>

...
<head>
	...
	<title>我的站点燃油申请</title>
	<meta name="keywords" content="我的站点燃油申请">
    <meta name="description" content="我的站点燃油申请">
        ...
        <div class="row wrapper border-bottom gray-bg page-heading">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb gray-bg">
                    ...
                    <li>
                        <label>我的站点燃油申请</label>
                    </li>
                </ol>
            </div>
        </div>
       <form action="dealercommit" method="post">
...
<!--弹窗-->
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/dealercommit.js"></script>

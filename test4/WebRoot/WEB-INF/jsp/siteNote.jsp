...
<title>我的燃油收支表</title>
<meta name="keywords" content="我的燃油收支表">
<meta name="description" content="我的燃油收支表">
<link
            ...
            <div class="row">
                ...
                <div class="col-md-1" style="margin-top: 20px;">
                    ...
                    <div class="col-md-12 btn btn-primary" style="color:white;margin-top: -20px;">
                    	<a href="${pageContext.request.contextPath}/site/dealercommit" style="color:white;">申请提取<a/>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12" id="jilu">
                    <div class="ibox float-e-margins" id="showORhidden">
                        <div class="ibox-title p0">
                            <form class="form-inline" method="post" action="showyou">
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tfoot>
                                	<tr class="gray-bg">
											...
											<td class="text-right" colspan="2">共${pages.totalCount

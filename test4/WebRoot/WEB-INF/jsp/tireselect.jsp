...
<head>
	...
	<title>查看轮胎站点</title>
	<meta name="keywords" content="查看轮胎站点">
    <meta name="description" content="查看轮胎站点">
                        ...
                        <div class="col-lg-12 bordered">
                            ...
                            <div class="col-lg-8 col-md-9  p20">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="siteName" value="${gass.siteName}" class="form-control" id="zdname" readonly="readonly"
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-2 col-sm-10 ">
                                            <input type="text" value="${gass.longitude}" name="longitude" id="jd" readonly="readonly" class="form-control" placeholder="">
                                        </div>
                                        <label class=" col-sm-1 control-label"><span
                                                class="text-danger">*</span>纬度:</label>
                                        <div class="col-md-2 col-sm-10 ">
                                            <input type="text" value="${gass.latitude}" name="latitude" id="wd" readonly="readonly" class="form-control" placeholder="">
                                        </div>
                                        <!-- <div class="col-md-2 col-sm-10 ">
                                            <input type="button"  class="form-control" style="background-color: #008ee0;color: white" value="自动获取">
                                        </div> -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3 col-sm-10 ">
                                            <input type="text" name="contact" value="${gass.contact}" id="lxr" readonly="readonly" class="form-control" placeholder="">
                                        </div>
                                        <label class=" col-sm-1 control-label"><span
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-lg-8 itit_radio">
                                        	<input type="text" value="${gass.tyreBrand}" readonly="readonly" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-lg-8 itit_radio">
                                        	<input type="text" value="${gass.typrSpec}" readonly="readonly" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-lg-8 itit_radio">
                                        	<input type="text" value="${gass.typrMaterial}" readonly="readonly"  class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                    <textarea class="col-md-10col-sm-12 col-xs-12" readonly="readonly" rows="3" name="description" id="base_case"
                                ...
                                <div class="form-group col-sm-12">
                                    <div class=" col-sm-6" style="text-align: center">
                                        <a style="width: 30%" class="btn btn-md btn-primary" onClick="back1(this);">返回</a>
                                    </div>
                                </div>
                            </div>

	...
	<%@include file="common/header.jsp"%>
        ...
        <div class="wrapper wrapper-content animated">
            <div class="row white-bg">
                <form method="post" action="jiayou">
                    <div class="col-md-11 fa_fa">
                        <div class="form-group col-md-11">
                            <label  class="col-md-1"><span class="text-danger">*</span>会员名称:</label>
                        ...
                        <div class="form-group col-md-11">
                            <label  class="col-md-1"><span class="text-danger">*</span>站点名称:</label>
                        ...
                        <div class="form-group col-md-11">
                            <label  class="col-md-1"><span class="text-danger">*</span>加油量(L):</label>
